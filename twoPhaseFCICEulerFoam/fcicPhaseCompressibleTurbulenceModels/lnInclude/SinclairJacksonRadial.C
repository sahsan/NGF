...
Foam::fcicKineticTheoryModels::radialModels::SinclairJackson::SinclairJackson
(
...
Foam::fcicKineticTheoryModels::radialModels::SinclairJackson::g0
(
...
Foam::tmp<Foam::volScalarField>
Foam::fcicKineticTheoryModels::radialModels::SinclairJackson::g0prime
(
    const volScalarField& alpha,
    const dimensionedScalar& alphaMinFriction,
    const dimensionedScalar& alphaMax

...
Foam::fcicKineticTheoryModels::granularPressureModels::Lun::Lun
(
...
Foam::fcicKineticTheoryModels::granularPressureModels::Lun::granularPressureCoeff
(
...
Foam::tmp<Foam::volScalarField>
Foam::fcicKineticTheoryModels::granularPressureModels::Lun::

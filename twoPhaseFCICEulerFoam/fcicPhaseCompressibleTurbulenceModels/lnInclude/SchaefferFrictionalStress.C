...
Foam::fcicKineticTheoryModels::frictionalStressModels::Schaeffer::Schaeffer
(
...
Foam::tmp<Foam::volScalarField>
Foam::fcicKineticTheoryModels::frictionalStressModels::Schaeffer::nu
(
    const phaseModel& phase,
    const dimensionedScalar& alphaMinFriction,
    const dimensionedScalar& alphaMax,
...
bool Foam::fcicKineticTheoryModels::frictionalStressModels::Schaeffer::read()
{

...
Foam::fcicKineticTheoryModels::viscosityModels::eulerNonlocalGF::calcNu(const volScalarField& pf, const volScalarField& pa) const
{
    ...
    volScalarField tau_inv_par = relaxPa_*alpha_*gnz;
...
Foam::fcicKineticTheoryModels::viscosityModels::eulerNonlocalGF::eulerNonlocalGF
(
 const word& name,
...
/*
Foam::tmp<Foam::volScalarField>
Foam::fcicKineticTheoryModels::viscosityModels::eulerNonlocalGF::strainRate() const
{
...
bool Foam::fcicKineticTheoryModels::viscosityModels::eulerNonlocalGF::read
(
)
{

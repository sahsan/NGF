...
Foam::fcicKineticTheoryModels::viscosityModels::muIRheology::muIRheology
(
 const word& name,
...
/*
Foam::tmp<Foam::volScalarField>
Foam::fcicKineticTheoryModels::viscosityModels::muIRheology::strainRate() const
{
...
bool Foam::fcicKineticTheoryModels::viscosityModels::muIRheology::read
(
)
{

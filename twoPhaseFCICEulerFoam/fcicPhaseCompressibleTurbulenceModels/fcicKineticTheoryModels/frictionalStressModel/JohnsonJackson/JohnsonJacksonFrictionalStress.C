...
Foam::fcicKineticTheoryModels::frictionalStressModels::JohnsonJackson::
JohnsonJackson
(
...
Foam::tmp<Foam::volScalarField>
Foam::fcicKineticTheoryModels::frictionalStressModels::JohnsonJackson::nu
(
    const phaseModel& phase,
    const dimensionedScalar& alphaMinFriction,
    const dimensionedScalar& alphaMax,
...
bool Foam::fcicKineticTheoryModels::frictionalStressModels::JohnsonJackson::read()
{

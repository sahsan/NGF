...
Foam::fcicKineticTheoryModels::radialModels::CarnahanStarling::CarnahanStarling
(
...
Foam::fcicKineticTheoryModels::radialModels::CarnahanStarling::g0
(
...
Foam::tmp<Foam::volScalarField>
Foam::fcicKineticTheoryModels::radialModels::CarnahanStarling::g0prime
(
    const volScalarField& alpha,
    const dimensionedScalar& alphaMinFriction,
    const dimensionedScalar& alphaMax

...
Foam::fcicKineticTheoryModels::radialModels::LunSavage::LunSavage
(
...
Foam::fcicKineticTheoryModels::radialModels::LunSavage::g0
(
...
Foam::tmp<Foam::volScalarField>
Foam::fcicKineticTheoryModels::radialModels::LunSavage::g0prime
(
    const volScalarField& alpha,
    const dimensionedScalar& alphaMinFriction,
    const dimensionedScalar& alphaMax
